...
import { Flex, Image, Box, Text, HStack, SimpleGrid, Button } from "@chakra-ui/react";
            ...
            <Box position="relative">
                ...
                <Box position="absolute" top={5} right={10}>
                    <Text fontWeight="bold" fontSize="40px" fontStyle="italic">
                        {
                            Clarity[
                            item.attributes?.find((p) => p.trait_type === "Rarity")?.value || 0
                            ]
                        }
                    </Text>
                </Box>

                <HStack bg="rgba(0,0,0,4)" position="absolute" top={5} px="10px">
                    <Text>
